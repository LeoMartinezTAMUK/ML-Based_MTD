# Intrusion Classification (IC) Scoring Script
...
with open('intrusionClassification.pkl', 'rb') as f: # rb stands for read binary
...
num_features = 4  # Number of features (adjust as needed)
