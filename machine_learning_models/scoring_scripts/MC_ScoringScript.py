# Malware Classification (MC) Scoring Script
...
with open('malwareClassification.pkl', 'rb') as f: # rb stands for read binary
...
num_features = 21  # Number of features (adjust as needed)
